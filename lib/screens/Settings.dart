                  ...
                  child: Stack(
                    children: [
                      Positioned(
                        ...
                        top: 9,
                        child:
                        Icon(Icons.add_location_alt_outlined, color: Colors.black, size: 36,),
                      ),
                      Positioned(
                        left: 60,
                        top: 17,
                  ...
                  child: Stack(
                    children: [
                      Positioned(
                        ...
                        top: 9,
                        child:
                        Icon(Icons.notifications_active_outlined, color: Colors.black, size: 36,),
                      ),
                      Positioned(
                        left: 60,
                        top: 17,
                  ...
                  child: Stack(
                    children: [
                      Positioned(
                        ...
                        top: 9,
                        child:
                        Icon(Icons.share, color: Colors.black, size: 36,),),
                      Positioned(
                        left: 60,
                        top: 17,
                        child:
                  ...
                  child: Stack(
                    children: [
                      Positioned(
                        ...
                        top: 9,
                        child:
                        Icon(Icons.logout, color: Colors.black, size: 36,),
                      ),
                      Positioned(
                        left: 60,
                        top: 17,
              ...
              child:Center(
                  child: RichText(
                    text: TextSpan(
                        style: GoogleFonts.roboto(fontSize: 18, color: Colors.black,),
                        children: [
                          TextSpan(text: 'We Are Loyal to Our Core Values\n\n', style: TextStyle(fontWeight: FontWeight.bold)),
                          TextSpan(text: 'We are dedicated to our fundamental beliefs that give included advantages '
                          ...
                          TextSpan(text: 'We Build Strong Relationships. We put vigorously in building long haul '
                              'connections by giving quality, client encounters, and execution in your product items.'),
                          TextSpan(text: '\n\nWe Are Quality Conscious\n\n', style: TextStyle(fontWeight: FontWeight.bold)),
                          TextSpan(text: 'We adore quality searchers. Henceforth, our prime center is programming '
                              'quality that wins us some genuine praises from customers and their end-clients.'),
                          TextSpan(text: '\n\nWe Are Creative and Innovative\n\n', style: TextStyle(fontWeight: FontWeight.bold)),
                          TextSpan(text: 'Our capacities to thoroughly consider of-box bring advancement, upheaval,'
                              ' and uniqueness even by pushing the limits somewhat more distant than anybody can.'),
                          TextSpan(text: '\n\nOur Mission\n\n', style: TextStyle(fontWeight: FontWeight.bold)),
                          TextSpan(text: 'To decide our strength in the present and up and coming programming '
                              'innovations by conveying modern arrangements that keeping them serving and remaining '
                              'for more.'),
                          TextSpan(text: '\n\nOur Vision\n\n', style: TextStyle(fontWeight: FontWeight.bold)),
                          TextSpan(text: 'To acquire profound respect from the supporters over the globe and distinctive'
